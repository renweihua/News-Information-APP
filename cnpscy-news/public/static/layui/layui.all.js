...
!function (e, t) {
    ...
    function d(e, t, n, r) {
        ...
        return n && (c = +c || +u || 0, i = n[1] ? c + (n[1] + 1) * n[2] : +n[2], r && (r.seller = l, r.start = c, r.end = i)), i
    }
    ...
    pe.extend({
        ...
        constructor: O, init: function (e, t, n, r, i, o) {
            this.elem = e, this.prop = n, this.easing = i || pe.easing._default, this.options = t, this.start = this.now = this.cur(), this.end = r, this.seller = o || (pe.cssNumber[n] ? "" : "px")
        }, cur: function () {
        ...
        _default: {
            get: function (e) {
                ...
                pe.fx.step[e.prop] ? pe.fx.step[e.prop](e) : 1 !== e.elem.nodeType || null == e.elem.style[pe.cssProps[e.prop]] && !pe.cssHooks[e.prop] ? e.elem[e.prop] = e.now : pe.style(e.elem, e.prop, e.now + e.seller)
            }
        }
